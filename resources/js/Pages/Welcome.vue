...
<template>
    	...
    	<!--Nav-->
	<nav class="bg-cyan-900 p-4 mt-0 w-full">
        <div class="container mx-auto flex items-center">
		    <div class="flex text-white font-extrabold">
				<a class="flex text-white text-base no-underline hover:text-white hover:no-underline" href="/login"> 
					 <span class="hidden w-0 md:w-auto md:block pl-1 text-orange-500">David Maza</span>
				</a>
            </div>
...
<div class="container w-full max-w-6xl mx-auto px-2 py-8 text-center ">
                
         <h1  class="text-6xl text-amber-400">CURSO FRONT END WEB DEVELOPER</h1>
         
            <section class="py-1 text-center container">
                    
                    <div class="row py-lg-5">
                        <div class="col-lg-9 col-md-8 mx-auto mt-5">
                            
                            <p class="text-cyan-100" >Aquí encontrarás la recopilación de los ejercicios de evaluación del CURSO FRONT-END WEB DEVELOPER  de Multimedia Tarragona.</p>
                            <p  class="text-gray-400" >Recuerda seguir las directrices de los enunciadios del curso</p>
                ...
                <div class="h-full bg-white rounded overflow-hidden shadow-md hover:bg-amber-100 relative smooth">
                    <a href="https://github.com/d-maza" class="no-underline hover:no-underline">
                            ...
                            <div class="p-6 h-auto md:h-48">	
                                <p class="text-sky-700  text-base mb-2">PC1-1</p>
                               
                                <div class="font-bold text-xl  text-blue-500">Yoda Say</div>
                                <br>
                                <p class="text-gray-800  text-base mb-5">
                                    Descarga el repositorio de YodaSay de npm y cambia el mensaje de Yoda . 
                                </p>
                            </div>
                            <div class="flex items-center justify-between inset-x-0 bottom-0 p-6">
                                <svg xmlns="http://www.w3.org/2000/svg"  color="grey" width="30" height="30" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
                                ...
                                <p class="text-gray-600 text-xs md:text-sm">NodeJS - JavaScript</p>
                            </div>
                    </a>
                </div>
            </div>
                ...
                <div class="h-full bg-white rounded overflow-hidden shadow-md hover:bg-amber-100 relative smooth">
                    <a href="https://github.com/d-maza/PC2-NODE-EXPRESS" class="no-underline hover:no-underline">
                            ...
                            <div class="p-6 h-auto md:h-48">	
                                ...
                                <br>
                                <p class="text-gray-800  text-base mb-5">
                                    Pasa el paramento (nombre) por la url y comprueba si está dentro de la array de nombres predefinidos. 
                                </p>
                            </div>
                            <div class="flex items-center justify-between inset-x-0 bottom-0 p-6">
                                <svg xmlns="http://www.w3.org/2000/svg" color="grey" width="30" height="30" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
                                ...
                                <!-- <img class="w-8 h-8 rounded-full mr-4" src="http://i.pravatar.cc/300" alt="Avatar of Author"> -->
                                <p class="text-gray-600 text-xs md:text-sm">NodeJS - Express - Ejs</p>
                            </div>
                    </a>
                </div>
            </div>
            <div class="w-full md:w-1/3 px-2 pb-12">
                <div class="h-full bg-white rounded overflow-hidden shadow-md hover:bg-amber-100 relative smooth">
                    <a href="https://github.com/d-maza/PC3-CRUD-NODE-MONGODB" class="no-underline hover:no-underline">
                            ...
                            <div class="p-6 h-auto md:h-48">	
                                <p class="text-sky-700  text-base mb-2">P3-1</p>
                                <div class="font-bold text-xl  text-blue-500 ">NodeJS CRUD con MonogoDB</div>
                                <br>
                                <p class="text-gray-800  text-base mb-5">
                                    Crea una base de Datos de Stras Wars con MongoDB y realiza un CRUD.
                                </p>
                            </div>
                            <div class="flex items-center justify-between inset-x-0 bottom-0 p-6">
                                <svg xmlns="http://www.w3.org/2000/svg"  color="grey" width="30" height="30" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
                                ...
                                <!-- <img class="w-8 h-8 rounded-full mr-4" src="http://i.pravatar.cc/300" alt="Avatar of Author"> -->
                                <p class="text-gray-600 text-xs md:text-sm">NodeJS - Express - Ejs  - Mongodb</p>
                            </div>
                    </a>
                </div>
            </div>
            ...
            <div class="w-full md:w-1/3 px-2 pb-12">
                <div class="h-full bg-white rounded overflow-hidden shadow-md hover:bg-amber-100 relative smooth">
                    <a href="https://github.com/d-maza">
                            ...
                            <div class="p-6 h-auto md:h-48">	
                                <p class="text-sky-700  text-base mb-2">PC1-2</p>
                                <div class="font-bold text-xl  text-blue-500">Formulario PHP & SQLite</div>
                                <br>
                                <p class="text-gray-800  text-base mb-5">
                                    Crea un formulario de registro que conecte u una BBDD de SQlite. 
                                </p>
                            </div>
                            <div class="flex items-center justify-between inset-x-0 bottom-0 p-6">
                                <svg xmlns="http://www.w3.org/2000/svg" color="grey" width="30" height="30" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
                                ...
                                <!-- <img class="w-8 h-8 rounded-full mr-4" src="http://i.pravatar.cc/300" alt="Avatar of Author"> -->
                                <p class="text-gray-600 text-xs md:text-sm">PHP - SQLite - Bootstrap</p>
                            </div>
                    </a>
                </div>
            </div>
            <div class="w-full md:w-1/3 px-2 pb-12">
                <div class="h-full bg-white rounded overflow-hidden hover:bg-amber-100 relative smooth">
                    <a href="https://github.com/d-maza/PC2-2-Laravel---Jetstream">
                            ...
                            <div class="p-6 h-auto md:h-48">	
                                <p class="text-sky-700  text-base mb-2">P2-2</p>
                                <div class="font-bold text-xl  text-blue-500">Routes Laravel</div>
                                <br>
                                <p class="text-gray-800  text-base mb-5">
                                    Crear diferentes tutas en Laravel, usando grupo de rutas, prefix y middleware de autentificacion. 
                                </p>
                            </div>
                            <div class="flex items-center justify-between inset-x-0 bottom-0 p-6">
                                <svg xmlns="http://www.w3.org/2000/svg" color="grey" width="30" height="30" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
                                ...
                                <!-- <img class="w-8 h-8 rounded-full mr-4" src="http://i.pravatar.cc/300" alt="Avatar of Author"> -->
                                <p class="text-gray-600 text-xs md:text-sm">Laravel - JetStream - Blade - MySQL</p>
                            </div>
                    </a>
                </div>
            </div>
            <div class="w-full md:w-1/3 px-2 pb-12">
                <div class="h-full bg-white rounded overflow-hidden shadow-md hover:bg-amber-100 relative smooth">
                    <a href="https://github.com/d-maza">
                            ...
                            <div class="p-6 h-auto md:h-48">	
                                <p class="text-sky-700  text-base mb-2">P3-2</p>
                                <div class="font-bold text-xl  text-blue-500">Crea un proyecto web</div>
                                <p class="text-gray-800 text-base mb-5">
                                    <ol>Backend funcional y conexión con base de datos.</ol>
                                    <ol>Frontend MVC trabajado y profesional. </ol>
                                    <ol>Creación de un diseño coherente.</ol>   
                            ...
                            <div class="flex items-center justify-between inset-x-0 bottom-0 p-6">
                                ...
                                <!-- <img class="w-8 h-8 rounded-full mr-4" src="http://i.pravatar.cc/300" alt="Avatar of Author"> -->
                                <p class="text-gray-600 text-xs md:text-sm">Laravel - JetStream - Vue - Tailwind</p>
                            </div>
                    </a>
                </div>
            </div>
		...
		<div class="container max-w-6xl mx-auto flex items-center px-2 py-8">
			...
			<div class="w-full mx-auto flex flex-wrap items-center">
				<div class="flex w-full md:w-1/2 justify-center md:justify-start text-white font-extrabold">
						...
						🐙 <span class="text-base text-gray-200">DiceCode™</span>
					
				</div>
				<div class="flex w-full pt-2 content-center justify-between md:w-1/2 md:justify-end">
					<ul class="list-reset flex justify-center flex-1 md:flex-none items-center">
					  <li>
						<a class="inline-block py-2 px-3 text-white no-underline" href="https://github.com/d-maza">GitHub</a>
					  </li>
					  <li>
                        <a class="inline-block py-2 px-3 text-white no-underline" href="https://www.linkedin.com/in/davidmaza76/">Linkedin</a>
